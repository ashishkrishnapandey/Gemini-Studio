      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-brand-gray border border-white/5 p-12 lg:p-24 relative overflow-hidden mb-24">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <form 
                className="w-full max-w-lg flex flex-col sm:flex-row gap-0" 
            ...
            >
                ...
                type="email" 
                />
                <button className="bg-white text-black font-bold font-mono uppercase tracking-widest px-8 py-5 hover:bg-brand-green transition-colors whitespace-nowrap" type="submit">
                Get in Touch
                </button>
            </form>
